...
<div align="center">
  ...
  <h3><b>Coup. - iMessage Automation</b></h3>
...
# 📖 Coup. - iMessage Automation Hero Page <a name="about-project"></a>
...
<details>
  ...
  <ul>
    <li><a href="https://nextjs.org/">Next.js 16 (App Router)</a></li>
  </ul>
</details>
...
<details>
  ...
  <ul>
    <li><a href="https://tailwindcss.com/">Tailwind CSS 4</a></li>
  </ul>
</details>
...
- [Live Demo Link](https://coup-hero.vercel.app/)
...
```sh
  cd my-folder
  git clone git@github.com:AbayomiOlaoye/coup-hero.git # Or using https: git clone https://github.com/AbayomiOlaoye/coup-hero.git
```
...
If you like this project, I'd love to hear what exactly you like about it!
...
I would like to thank Feeble Product Design Team for the inspiration and guidance.
